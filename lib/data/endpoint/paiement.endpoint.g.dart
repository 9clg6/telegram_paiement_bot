...
part of 'paiement.endpoint.dart';
...
class _PaiementEndpoint implements PaiementEndpoint {
  _PaiementEndpoint(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  Future<AuthenticationRemoteModel?> authenticate(
    ...
    _data.addAll(authenticationBody.toJson());
    final _options = _setStreamType<AuthenticationRemoteModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late AuthenticationRemoteModel? _value;
    try {
      _value = _result.data == null
          ? null
          : AuthenticationRemoteModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<MinimumAmountRemoteModel?> getMinimumAmount(
    ...
    final _options = _setStreamType<MinimumAmountRemoteModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(_options);
    late MinimumAmountRemoteModel? _value;
    try {
      _value = _result.data == null
          ? null
          : MinimumAmountRemoteModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
